  ...
  function _output( $value )
	{
		...
		$output = '<div class="cuztom_button_wrap">';
			...
			if ( $wp_version >= 3.5 ) {
				$output .= sprintf( '<input id="upload_file_button" type="button" class="button cuztom_button cuztom_upload_new cuztom_file" value="%s" class="cuztom_upload" />', __( 'Select file', CUZTOM_TEXTDOMAIN ) );
			}else{
				$output .= sprintf( '<input id="upload_file_button" type="button" class="button cuztom_button cuztom_upload_old cuztom_file" value="%s" class="cuztom_upload" />', __( 'Select file', CUZTOM_TEXTDOMAIN ) );
			}
